                    ...
                    <>
                        ...
                        <div className="flex flex-col items-center justify-center text-center space-y-4 py-8">
                            ...
                            <div className="p-4 bg-background border-4 border-dashed rounded-lg">
                                <Image src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=upi://pay?pa=farmer@fakebank&pn=EcoFighter's%20Farmer&am=${totalSaleValue}&cu=INR&tn=CropSale`} alt="QR Code" width={180} height={180} />
                            </div>
